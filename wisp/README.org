...
* Garbage Collection
  ...
  Cheney published the algorithm in 1970 [cite:@cheney1970].

  It's not working properly right now.  Somehow we're ending
  up with a lot of broken hearts everywhere and cycles.
